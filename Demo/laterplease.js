document.addEventListener('DOMContentLoaded', function(){
	...
	function buildListe(){
		if(localStorage.getItem('LaterPlease') != null){
			document.getElementById('cadreLater').innerHTML = '';//vider les anciens elements
			...
			for(var i=0;i<ArrayURL.length;i++){	//pour chaque élément de l'array, on ecrit dans la playlist
				document.getElementById('cadreLater').insertAdjacentHTML('beforeend', '<a href="'+ArrayURL[i]+'">'+ArrayURL[i]+'</a> <span class="supprLater" title="'+i+'" href="'+i+'">✕</span><br>');//un lien avec un bouton pour le supprimer
			}
